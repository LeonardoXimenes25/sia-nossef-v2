...
<div class="container-fluid px-0 news-page">
    ...
    <div class="news-header bg-primary text-white py-5 mb-5 text-center">
        <div class="container">
            <h1 class="display-4 fw-bold">Portal Informasaun Eskola</h1>
            <p class="lead mb-3">Informasaun konaba aktividade eskola</p>
    ...
    <div class="container pb-5">
        ...
        <div class="row mb-4 g-3">
            <div class="col-md-8">
                <form method="GET" action="{{ route('news.index') }}" class="d-flex">
                    <input type="text" name="search" class="form-control me-2" placeholder="BUka informasaun..." value="{{ request('search') }}">
        ...
        <div class="row mb-5">
            <div class="col-12">
                <h3 class="mb-3 border-bottom pb-2">Notisia Prinsipal</h3>
                        ...
                        <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                            <div class="row g-0 bg-dark text-white">
                                ...
                                <div class="col-md-6 p-4 d-flex flex-column justify-content-center">
                                    ...
                                    <a href="{{ route('news.show', $item->slug) }}" class="btn btn-outline-light align-self-start">Lee Detailu</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 news-card shadow-sm border-0 overflow-hidden">
                    ...
                    <div class="card-body d-flex flex-column">
                        <h5 class="card-title">{{ Str::limit($item->title), 15 }}</h5>
                        <p class="card-text text-muted flex-grow-1">{{ Str::limit(strip_tags($item->content), 120) }}</p>
                        <div class="d-flex justify-content-between align-items-center mt-auto">
                            <a href="{{ route('news.show', $item->slug) }}" class="btn btn-sm btn-outline-primary stretched-link">Lee Detailu</a>
